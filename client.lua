...
local textureFile = "nui://Kennzeichen/plates/plate.png" -- Path to main plate texture
local normalMapFile = "nui://Kennzeichen/plates/plate_n.png" -- Path to normal map texture
